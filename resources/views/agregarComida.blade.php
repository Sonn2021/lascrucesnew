        ...
        <div class="card w-100 shadow">
            ...
            <div class="card-body p-4">
                <form action="{{route('comida.submit')}}" method="POST" enctype="multipart/form-data">
                    ...
                    <label for="reservacion mt-5">Reservación</label>
                    ...
                    <button type="submit" class="btn btn-primary bg-brown w-100 mb-2" name="send" value="Submit">AGREGAR</button>
                    <a href="/preview-comida" class="text-light"><button type="button" class="btn btn-primary w-100">ATRÁS</button></a>
                </form>
            </div>
        </div>
    </div>  
